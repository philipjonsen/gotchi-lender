// ABI for the Aavegotchi Diamond
...
module.exports = [
  ...
  },
  {
    ...
    name: 'equippedWearables',
    outputs: [
      { internalType: 'uint16[16]', name: 'wearableIds_', type: 'uint16[16]' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
  {
    ...
    outputs: [
      { internalType: 'uint256[]', name: 'wearableSetIds_', type: 'uint256[]' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
  ...
  {
    inputs: [
      { internalType: 'uint32[]', name: '_erc721TokenIds', type: 'uint32[]' }
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256[]', name: 'revenueBalances', type: 'uint256[]' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
